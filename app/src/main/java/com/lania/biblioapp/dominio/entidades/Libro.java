...
public class Libro {
    ...
    public static Libro createLibroByContentValues(ContentValues contentValues) {
        String nombre = contentValues.getAsString(LIBRO_NOMBRE);
        Integer disponibilidad = contentValues.getAsInteger(LIBRO_DISPONIBILIDAD);
        Float precio = contentValues.getAsFloat(LIBRO_PRECIO);
        String autor = contentValues.getAsString(LIBRO_AUTOR);
        return createLibro(0L, nombre, disponibilidad, precio, autor);
    }
